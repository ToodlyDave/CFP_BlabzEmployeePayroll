...
// This service will handle the email services
@Service
public class MailServices implements IMailServices{

	public ResponseEntity<ResponseDTO> sendEmail(Email email) {
		
		final String fromEmail = "some.random.thing.email@gmail.com";
		final String fromPwd = "Qwerty1234@";
	...
	public String getLink(String token) {
		// TODO Auto-generated method stub
		return "http://localhost:8080/employeepayrollservice/verify/" + token;
	}
}
